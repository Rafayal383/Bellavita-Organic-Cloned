const sidebar = ()=>{
    return `
        ...
        <div class="sidemenu" onclick="ShowSkinCareOpt()">
          <a href="#">Skin Care</a>
          <p>⮟</p>
        </div>
        ...
        <div class="sidemenu" onclick="ShowBodyCareOpt()">
          <a href="#">Body Care</a>
          <p>⮟</p>
        </div>
        ...
        <div class="sidemenu" onclick="ShowPerfumeOpt()">
          <a href="#">Perfumes</a>
          <p>⮟</p>
        </div>
        ...
        <div class="sidemenu" onclick="showcomboopt()">
