      ...
      <div id="nav_item">
        <div class="nav_profile">
          <div class="nav_profile_icon">
            <a href="/dreary-hand-8237/loginSignup/signup.html">
              <img
        ...
        <div class="nav_search">
          ...
          <div class="nav_profile">
            <div class="nav_profile_icon1">
              <a href="/dreary-hand-8237/wishList/wishlist.html"
                ><img
          ...
          <div class="nav_profile">
            <div class="nav_profile_icon1">
              <a href="/dreary-hand-8237/Cart/cart.html">
                <img
          ...
          <div class="elements">
            <div>
              <p class="element-item">
                <a href="/dreary-hand-8237/single_Product/productPage.html"
                  >SHOP ALL</a
                >
              </p>
            </div>
            <div>
              <p class="element-item"><a href="#">DIWALI GIVEAWAY</a></p>
            </div>
            <div>
              <p class="element-item"><a href="#">BEST SELLERS</a></p>
            </div>
            <div>
              ...
              <div class="dropdown skinDropdown">
                <div class="dropdownlist">
                  ...
                  <div>
                    <a
                      href="/dreary-hand-8237/skincare/html_Files/Allproduct.html"
                      >ALL SKINCARE PRODUCTS</a
                    >
                    <a
                      href="/dreary-hand-8237/skincare/html_Files/faceCream.html"
                      >FACE CREAM</a
                    >
                    <a
                      href="/dreary-hand-8237/skincare/html_Files/facePack&mask.html"
                      >FACE PACK/MASK</a
                    >
                    <a
                      href="/dreary-hand-8237/skincare/html_Files/faceserum.html"
                      >FACE SERUM</a
                    >
                    <a
                      href="/dreary-hand-8237/skincare/html_Files/facescrub.html
                      "
                      >FACE SCRUB</a
                    >
                    <a href="#">FACE TONER</a>
            ...
            <div>
              ...
              <div class="dropdown bodyDropdown">
                <div class="dropdownlist">
                  ...
                  <div>
                    <a href="/dreary-hand-8237/Body_care/bodycarepage.html"
                      >ALL BODY CARE PRODUCTS</a
                    >
                    <a href="#">BODY SOAPS</a>
                    <a href="#">BODY WASH</a>
                    <a href="#">BODY SCRUB</a>
            ...
            <div>
              <p class="element-item">
                <a href="/dreary-hand-8237/Built_box/built_box.html"
                  >BUILD A BOX</a
                >
              </p>
            </div>
